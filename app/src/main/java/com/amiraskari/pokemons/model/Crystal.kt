...
data class Crystal (
   ...
   @SerializedName("back_shiny_transparent") var backShinyTransparent : String,
   @SerializedName("back_transparent") var backTransparent : String,
   @SerializedName("front_default") var frontDefault : String,
   @SerializedName("front_shiny") var frontShiny : String,
   @SerializedName("front_shiny_transparent") var frontShinyTransparent : String,
